...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Update manager data
    $stmt = $pdo->prepare("UPDATE managers SET name = ?, email = ?, image = ? WHERE role = 'admin'");
    if ($stmt->execute([$name, $email, $image])) {
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('<?= BASE_URL ?>assets/media/avatars/blank.png')">
                                    ...
                                    <div class="image-input-wrapper w-125px h-125px" style="background-image: url('<?= UPLOADS_URL . $admin->image ?>')"></div>
                        ...
                        <div class="row mb-6">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row">
                                <input type="email" name="email" class="form-control form-control-lg form-control-solid" placeholder="Enter email address" value="<?= htmlspecialchars($admin->email) ?>" required />
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-6">
                            <!--begin::Label-->
                            <label class="col-lg-4 col-form-label fw-semibold fs-6">Manager ID</label>
                            <!--end::Label-->
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row">
                                <input type="text" class="form-control form-control-lg form-control-solid" value="<?= $admin->manager_id ?>" disabled readonly />
                                <div class="form-text">Manager ID cannot be changed</div>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-6">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row">
                                <input type="text" class="form-control form-control-lg form-control-solid" value="<?= ucfirst($admin->role) ?>" disabled readonly />
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-6">
                            <!--begin::Label-->
                            <label class="col-lg-4 col-form-label fw-semibold fs-6">Created Date</label>
                            <!--end::Label-->
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row">
                                <input type="text" class="form-control form-control-lg form-control-solid" value="<?= date('M d, Y h:i A', strtotime($admin->created_at)) ?>" disabled readonly />
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (cancelBtn) {
            cancelBtn.addEventListener('click', function(e) {
                e.preventDefault();
                imagePreview.style.backgroundImage = `url('<?= UPLOADS_URL . $admin->image ?>')`;
                imageInput.value = '';
            });
        }
    });
