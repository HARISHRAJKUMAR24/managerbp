...
<body class="font-inter bg-gradient-radial text-white overflow-x-hidden">
    ...
    <main class="pt-32 relative overflow-hidden">
        ...
        <!-- Christmas Pricing Plans Section -->
        <section id="pricing" class="pricing py-20 px-4 sm:px-6 relative overflow-hidden">
            ...
            <div class="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                ...
                <!-- Christmas Overlay Gradient -->
                <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-r from-red-500/5 via-green-500/5 to-amber-500/5 rounded-full blur-3xl"></div>
            </div>

            <div class="max-w-7xl mx-auto relative z-10">
                <!-- Section Header with Christmas Theme -->
                <div class="text-center mb-16">
                    <!-- Christmas Badge -->
                    <div class="inline-flex items-center gap-2 bg-gradient-to-r from-red-500 to-green-500 text-white px-4 py-2 rounded-full mb-4">
                        <span class="text-lg">🎄🎅</span>
                        <span class="font-bold">CHRISTMAS SPECIAL OFFER</span>
                        <span class="text-lg">🤶🎁</span>
                    </div>

                    <h2 class="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">
                        <span class="text-white">Festive Pricing that saves time & money</span>
                    </h2>
                    <p class="text-base sm:text-lg lg:text-xl text-gray-300 max-w-3xl mx-auto">
                        Simple Christmas Pricing for Every Business! Know exactly what you pay, start growing this holiday season.
                    </p>
                </div>
                ...
                <div class="flex justify-center mb-12 lg:mb-16">
                    <div class="bg-white/5 rounded-2xl p-2 backdrop-blur-xl border border-white/10 relative">
                        <!-- Save Message Style Bubble with Christmas Theme -->
                        <div class="absolute -top-12 -right-4">
                            <div class="bg-gradient-to-r from-red-500 to-green-500 text-white px-4 py-2 rounded-2xl font-semibold text-sm shadow-lg relative">
                                <span class="flex items-center gap-2">
                                    <span>🎄</span>
                                    Save up to 67% yearly!
                                    <span>🎁</span>
                                </span>
                                <div class="absolute -bottom-2 right-6 w-4 h-4 bg-red-500 transform rotate-45"></div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-6 lg:gap-8 max-w-7xl mx-auto">
                            ...
                            if (count($allPlans) > 0) :
                                foreach ($allPlans as $row) :
                                    ...
                                    // UI Configuration (Kept same colors as original)
                                    $uiConfig = [
                                        'Welcome' => ['recommended' => false, 'best_value' => false, 'badge' => ''],
                                        'Starter Plan' => ['recommended' => false, 'best_value' => false, 'badge' => 'Xmas Offer'],
                                        'Intermediate' => ['recommended' => true, 'best_value' => false, 'badge' => 'Christmas Sale'],
                                        'Professional' => ['recommended' => false, 'best_value' => true, 'badge' => 'Christmas Special']
                                    ];
                            ...
                            ?>
                                    <div class="pricing-card group relative <?= $config['recommended'] || $config['best_value'] ? 'transform scale-105 z-10 mt-8 lg:mt-4' : '' ?>">
                                        <!-- Badge for Starter Plan -->
                                        <?php if ($planName === 'Starter Plan' && !empty($config['badge'])): ?>
                                            <div class="absolute -top-4 left-1/2 transform -translate-x-1/2 z-20">
                                                <div class="bg-gradient-to-r from-lime-400 to-emerald-500 text-black px-4 py-2 rounded-full text-sm font-bold shadow-lg animate-pulse whitespace-nowrap">
                                                    <?= $config['badge'] ?>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <?php if ($config['recommended']): ?>
                                            <div class="absolute -top-4 left-1/2 transform -translate-x-1/2 z-20">
                                                <div class="bg-gradient-to-r from-yellow-400 to-orange-500 text-black px-4 py-2 rounded-full text-sm font-bold shadow-lg animate-pulse whitespace-nowrap">
                                                    <?= $config['badge'] ?>
                                                </div>
                                            </div>
                                            ...
                                            <?php elseif ($config['best_value']): ?>
                                                <div class="absolute -top-4 left-1/2 transform -translate-x-1/2 z-20">
                                                    <div class="bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg animate-pulse whitespace-nowrap">
                                                        <?= $config['badge'] ?>
                                                    </div>
                                                </div>
                                                ...
                                                <?php else: ?>
                                                    <!-- Starter Plan with Christmas Theme -->
                                                    <?php if ($planName === 'Starter Plan'): ?>
                                                        <div class="bg-gradient-to-br from-emerald-500/20 to-green-500/20 rounded-3xl p-6 h-full border-2 border-purple-400/30 backdrop-blur-xl transition-all duration-500 shadow-lg shadow-emerald-500/10">
                                                        <?php else: ?>
                                                        ...
                                                        <div class="text-center mb-6">
                                                            ...
                                                            <?php if ($showSavings): ?>
                                                                ...
                                                                <div class="flex items-center justify-center gap-2 mb-3">
                                                                    <span class="bg-gradient-to-r from-red-500 to-green-500 text-white text-xs px-3 py-1 rounded-full font-bold">
                                                                        🎄 <?= $discountPercentage ?>% OFF 🎄
                                                                    </span>
                                                            ...
                                                            <p class="text-gray-500 text-xs mt-1">
                                                                <span class="text-green-400">✓</span> Inclusive of GST
                                                            </p>
                                                        </div>

                                                        <!-- Features (NO highlighting for Starter Plan) -->
                                                        <ul class="space-y-3 mb-4 <?= $planSlug ?>-features">
                                                            ...
                                                            ?>
                                                                ...
                                                                <?php else: ?>
                                                                    <!-- Normal features for all plans -->
                                                                    <li class="flex items-center gap-2">
                                                                        <?php if ($planName === 'Starter Plan'): ?>
                                                                            <!-- Christmas checkmark for Starter Plan -->
                                                        ...
                                                        } elseif ($planName === 'Starter Plan') {
                                                            // Christmas theme for Starter Plan button
                                                            $buttonClass .= "bg-gradient-to-br from-amber-400 to-yellow-500 text-black shadow-lg hover:scale-105 hover:shadow-amber-400/30 font-bold";
                                                        } else {
                                                ...
                                                endforeach;
                                                    ...
                                                    <div class="col-span-4 text-center py-12">
                                                        <div class="bg-gradient-to-r from-red-500/10 to-green-500/10 rounded-2xl p-8 backdrop-blur-xl border border-white/10">
                                                ...
                                                <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-6 lg:gap-8 max-w-7xl mx-auto">
                                                    ...
                                                    ?>
                                                            <div class="pricing-card group relative <?= $config['recommended'] || $config['best_value'] ? 'transform scale-105 z-10 mt-8 lg:mt-4' : '' ?>">
                                                                ...
                                                                <?php if ($config['recommended']): ?>
                                                                    <div class="absolute -top-4 left-1/2 transform -translate-x-1/2 z-20">
                                                                        <div class="bg-gradient-to-r from-yellow-400 to-orange-500 text-black px-6 py-2 rounded-full text-sm font-bold shadow-lg animate-pulse whitespace-nowrap">
                                                                            <?= $config['badge'] ?>
                                                                        </div>
                                                                    </div>
                                                                    <div class="bg-gradient-to-br from-ztore-purple/30 to-ztore-pink/30 rounded-3xl p-6 h-full border-2 border-yellow-400/50 backdrop-blur-xl shadow-2xl shadow-yellow-400/20">
                                                                    <?php elseif ($config['best_value']): ?>
                                                                        <div class="absolute -top-4 left-1/2 transform -translate-x-1/2 z-20">
                                                                            <div class="bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-6 py-2 rounded-full text-sm font-bold shadow-lg animate-pulse whitespace-nowrap">
                                                                                <?= $config['badge'] ?>
                                                                            </div>
                                                                        </div>
                                                                        <div class="bg-gradient-to-br from-amber-400/30 to-orange-500/30 rounded-3xl p-6 h-full border-2 border-purple-400/50 backdrop-blur-xl shadow-2xl shadow-purple-400/20">
                                                                    ...
                                                                    <!-- Christmas Trust Badge -->
                                                                    <div class="text-center mt-16">
                                                                        <div class="inline-flex flex-col items-center gap-6">
                                                                            <div class="bg-gradient-to-r from-red-500/10 via-green-500/10 to-amber-500/10 rounded-2xl p-6 border border-white/10 backdrop-blur-sm max-w-2xl">
                                                                                <div class="flex flex-col sm:flex-row items-center justify-center gap-4 text-gray-300">
                                                                                    <div class="flex items-center gap-3">

                                                                                        <span class="text-sm sm:text-base">14-day money-back guarantee</span>
                                                                                    </div>
                                                                            ...
                                                                            <div class="text-gray-400 text-sm flex items-center gap-2">
                                                                                ...
                                                                                <span>Christmas offer valid until December 26, 2025</span>
                                                                                <span class="text-green-400 animate-pulse" style="animation-delay: 0.2s">🎄</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
        ...
        <style>
            ...
            /* Keep original CSS for See More/Less Animations */
