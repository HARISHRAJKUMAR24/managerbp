...
// Subscrption Histories functions
// Add this function to functions.php
// Subscrption Histories functions
if (!function_exists('getAllSubscriptionHistories')) {
    function getAllSubscriptionHistories() {
        $pdo = getDbConnection();
        
        $query = "SELECT sh.*, sp.name as plan_name 
        ...
        try {
            ...
            error_log("Database error in getAllSubscriptionHistories(): " . $e->getMessage());
            return [];
        }
    }
}

// Also add this function if it doesn't exist
if (!function_exists('fetchSubscriptionHistoryById')) {
    function fetchSubscriptionHistoryById($id) {
        $pdo = getDbConnection();
        ...
        try {
            ...
            error_log("Database error in fetchSubscriptionHistoryById(): " . $e->getMessage());
            return false;
        }
    }
}